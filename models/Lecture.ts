...
export default class LectureModel {
  ...
  public static PATH_INCLUDE =
    'subject.id,subject.name,subject.module.id,subject.module.semesterName,subject.module.name,subject.module.customGPT,subject.module.year.id,subject.module.year.faculty';
