...
facultyRouter.post('/faculties/:facultyId/update', controller.updateFaculty)
...
facultyRouter.post('/faculties/:facultyId/years/:yearId/update', controller.updateYear)
