        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!user || user.role !== client_1.UserRole.Admin)
                    return (0, responses_1.unauthorized)(res, "Unauthorized cannot create a module.");
                ...
                const newModule = yield db_1.default.module.create({
                    data: Object.assign(Object.assign({ yearId }, parsedBody.data), { createdAt: (0, helpers_1.currentDate)() })
                });
    ...
    createSubject(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const user = yield AuthController_1.default.user(req, res);
                if (!user || user.role !== client_1.UserRole.Admin)
                    return (0, responses_1.unauthorized)(res, "Unauthorized cannot create a subject.");
                ...
                const newSubject = yield db_1.default.subject.create({
                    data: Object.assign(Object.assign({ moduleId }, parsedBody.data), { createdAt: (0, helpers_1.currentDate)() })
                });
                yield db_1.default.practicalData.create({
                    data: {
                ...
                yield db_1.default.finalRevisionData.create({
                    data: {
    ...
    updateModule(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const user = yield AuthController_1.default.user(req, res);
                if (!user || user.role !== client_1.UserRole.Admin)
                    return (0, responses_1.unauthorized)(res, "Unauthorized cannot update a module.");
                const yearId = (0, helpers_1.parameterExists)(req, res, "yearId");
                const moduleId = (0, helpers_1.parameterExists)(req, res, "moduleId");
                if (!yearId)
                    return (0, responses_1.badRequest)(res, "Invalid yearId");
    ...
    deleteModule(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const user = yield AuthController_1.default.user(req, res);
                if (!user || user.role !== client_1.UserRole.Admin)
                    return (0, responses_1.unauthorized)(res, "Unauthorized cannot delete a module.");
                const yearId = (0, helpers_1.parameterExists)(req, res, "yearId");
                const moduleId = (0, helpers_1.parameterExists)(req, res, "moduleId");
                if (!yearId)
                    return (0, responses_1.badRequest)(res, "Invalid yearId");
